...
//! let g = digraph![
//! 	(char, Cell<u64>) => [u64]
//! 	('A', std::Cell::new(u64::MAX)) => [ ('B', 4), ('H', 8) ]
//! 	('B', std::Cell::new(u64::MAX)) => [ ('A', 4), ('H', 11), ('C', 8) ]
//! 	('C', std::Cell::new(u64::MAX)) => [ ('B', 8), ('C', 2), ('F', 4), ('D', 7) ]
//! 	('D', std::Cell::new(u64::MAX)) => [ ('C', 7), ('F', 14), ('E', 9) ]
//! 	('E', std::Cell::new(u64::MAX)) => [ ('D', 9), ('F', 10) ]
//! 	('F', std::Cell::new(u64::MAX)) => [ ('G', 2), ('C', 4), ('D', 14), ('E', 10) ]
//! 	('G', std::Cell::new(u64::MAX)) => [ ('H', 1), ('I', 6), ('F', 2) ]
//! 	('H', std::Cell::new(u64::MAX)) => [ ('A', 8), ('B', 11), ('I', 7), ('G', 1) ]
//! 	('I', std::Cell::new(u64::MAX)) => [ ('H', 7), ('C', 2), ('G', 6) ]
//! ];
//!
